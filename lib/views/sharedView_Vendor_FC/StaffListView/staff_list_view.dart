...
class _StaffListViewState extends State<StaffListView> {
  ...
  Widget build(BuildContext context) {
    ...
    SearchForStaff.staffList = staffList;
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return ItemStaffView(
          ...
          onRemoveSelected: () =>
              ManageStaffViewController.removeStaff(context, staffList[index]),
          onEditSelected: () =>
              ManageStaffViewController.editStaff(context, staffList[index]),
          onCallSelected: () =>
              ManageStaffViewController.callStaff(context, staffList[index]),
        );
      },
    );
  }
