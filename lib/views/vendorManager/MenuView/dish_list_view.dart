  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return ItemDishView(
          dish: dishList[index],
          onRemoveSelected: () => MenuViewController.removeDish(context, dishList[index]),
          onEditSelected: () => MenuViewController.editDish(context, dishList[index]),
          onDiscountSelected: () => MenuViewController.discountDish(context, dishList[index]),
        );
      },
    );
  }
